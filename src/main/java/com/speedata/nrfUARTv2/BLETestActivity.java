...
public class BLETestActivity extends BaseActivity implements
    ...
    private void initUI() {
        ...
        spCmd = (Spinner) findViewById(R.id.sp_cmd);
        adpater = new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line,
            ...
            public void onClick(View v) {
                if (!mBtAdapter.isEnabled()) {
                    ...
                    if (btnConnectDisconnect.getText().equals("Connect")) {
                        ...
                        Intent newIntent = new Intent(BLETestActivity.this,
...
//                            }
//                            recePackageCount++;
//                            Log.e(TAG, recePackageCount + "  " + text);
//                            if (text.equals("DATA_END")) {
//                                isCounter = false;
//                                String currentDateTimeString = DateFormat
//                                        .getTimeInstance().format(new Date());
//                                listAdapter.add("[" + currentDateTimeString
//                                        + "] RX:rece_pkg_count= " + recePackageCount);
//                                messageListView.smoothScrollToPosition(listAdapter
//                                        .getCount() - 1);
//                            }
                        } catch (Exception e) {
